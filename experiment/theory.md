...
<p style="text-align:center; font-style:italic;">BD = AB sinθ = d sinθ &nbsp;&nbsp;&nbsp;&nbsp;&hellip;(1)</p>

The corresponding **phase difference** is:

<p style="text-align:center; font-style:italic;">ϕ = (2π / λ) &middot; d sinθ &nbsp;&nbsp;&nbsp;&nbsp;&hellip;(2)</p>
...
<p style="text-align:center; font-style:italic;">&epsilon; = (1/n) &middot; (2π / λ) d sinθ</p>

The **resultant amplitude** at P₀ is:

<p style="text-align:center; font-style:italic;">A = a &middot; sin(n&epsilon;/2) / sin(&epsilon;/2) &nbsp;&nbsp;&nbsp;&nbsp;&hellip;(3)</p>

Letting α = πd sinθ / λ, the **intensity** at any point in the diffraction pattern is:

<p style="text-align:center; font-style:italic;">I = I₀ &middot; (sinα / α)² &nbsp;&nbsp;&nbsp;&nbsp;&hellip;(4)</p>
...
<p style="text-align:center; font-style:italic;">θ = 0° &nbsp;&nbsp;(central maximum)</p>

<p style="text-align:center; font-style:italic;">d sinθ &asymp; (k + &frac12;)λ &nbsp;&nbsp;for k = 0, 1, 2, 3, &hellip; &nbsp;&nbsp;&nbsp;&nbsp;&hellip;(5)</p>
...
<p style="text-align:center; font-style:italic;">d sinθ = kλ &nbsp;&nbsp;for k = 1, 2, 3, … &nbsp;&nbsp;&nbsp;&nbsp;&hellip;(6)</p>
...
<p style="text-align:center; font-style:italic;">&Delta;θ = arcsin(λ / d) &asymp; λ / d &nbsp;&nbsp;(for small angles) &nbsp;&nbsp;&nbsp;&nbsp;&hellip;(7)</p>
